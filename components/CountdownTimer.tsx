...
const CountdownTimer: React.FC<CountdownTimerProps> = ({ compact = false }) => {
  ...
  return (
    ...
    >
      ...
      {/* Countdown Display */}
      <div className={`flex items-center ${compact ? 'gap-1.5' : 'gap-1 md:gap-2'}`}>
        <div className="text-center">
          <div className={`${compact ? 'text-base' : 'text-base md:text-xl'} font-bold font-serif leading-tight`} style={{ color: 'rgba(25, 171, 228, 1)' }}>
