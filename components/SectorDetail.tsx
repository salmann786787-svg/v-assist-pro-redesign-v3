...
const SectorDetail: React.FC<SectorDetailProps> = ({ sector, onBack, onOpenProtocol }) => {
  ...
  return (
    ...
    >
      ...
      <button
        onClick={onBack}
        className="mb-12 flex items-center gap-3 text-xs uppercase tracking-widest text-gray-600 dark:text-white hover:text-accent transition-colors group"
      ...
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 mb-20">
          ...
          <div>
            ...
            <p className="text-xl text-gray-600 dark:text-white font-light max-w-md leading-relaxed mb-12 border-l-2 border-accent pl-6" style={{ fontFamily: 'Lato, sans-serif' }}>
              {sector.subtitle}
            </p>
            ...
            <div className="space-y-8">
              {sector.impact.stats.map((stat, i) => (
                <div key={i} className="flex items-center justify-between border-b border-dark/5 dark:border-white/5 pb-4">
                  <span className="text-xs text-gray-600 dark:text-white uppercase tracking-wider" style={{ fontFamily: 'Lato, sans-serif' }}>{stat.label}</span>
        ...
        <div className="mb-32" style={{ borderColor: 'rgba(255, 255, 255, 0.1)', borderTopWidth: '1px', borderWidth: '1px 0px 0px', marginBottom: '128px', paddingTop: '80px' }}>
          ...
          <p className="text-lg text-gray-600 dark:text-white mb-12 max-w-3xl" style={{ fontFamily: 'Lato, sans-serif' }}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {sector.frictions.map((friction, i) => (
              ...
              >
                ...
                <p className="text-sm text-gray-600 dark:text-white leading-relaxed" style={{ fontFamily: 'Lato, sans-serif' }}>{friction.description}</p>
              </motion.div>
            ))}
          </div>
        </div>
              ...
              >
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 dark:text-white leading-relaxed" style={{ fontFamily: 'Lato, sans-serif' }}>{solution.description}</p>
                  </div>
                </div>
              </motion.div>
            ))}
        ...
        {sector.caseStudy && (
          <div className="mb-32">
            <div className="bg-gradient-to-br from-accent/10 to-accent/5 p-12 md:p-16 border border-accent/20">
              ...
              <p className="text-lg text-gray-600 dark:text-white mb-8 leading-relaxed max-w-3xl" style={{ fontFamily: 'Lato, sans-serif' }}>
        ...
        <div className="bg-accent/5 border border-accent/20 p-12 md:p-16 text-center">
          ...
          <p className="text-lg text-gray-600 dark:text-white mb-8 max-w-2xl mx-auto" style={{ fontFamily: 'Lato, sans-serif' }}>
